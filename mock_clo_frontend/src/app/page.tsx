...
type TabOption = "create" | "invest" | "withdraw";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen dark:bg-gray-800 bg-gray-800">
              ...
              {!walletAddress ? (
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex gap-4 text-sm">
                    <span>
                      <span className="font-medium text-gray-600">APT: </span>
      ...
      {/* Footer */}
      <footer className="fixed bottom-0 left-0 bg-gray-700 right-0 border-t py-4">
        <div className="text-center">
          <a>Made with ❤️ by <span className="text-blue-600">Pact Labs</span></a>
        </div>
      </footer>
    </div>
  );
